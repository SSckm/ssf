...
function insertBlogList(msg) {
	...
	for (var i = 0; i < blogArray.length; i++) {
		...
		$("#lastBlogList")
				.append(
						"<div class=\"margin-top-20 profile-desc-link\"><a href=\"https://blog.soaer.com/"
								+ authId
								+ "/"
								+ blogKey
								+ ".html"
...
function ccl() {
	$.ajax({
		type : "GET",
		url : "https://blog.soaer.com/clog?" + "blogId=" + blogId + "&blogKey=" + blogKey,
		success : function(msg) {
		}
	});
}
